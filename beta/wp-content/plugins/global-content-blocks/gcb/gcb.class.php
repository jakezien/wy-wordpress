						...
						<form action="" name="del_gcb" method="POST" onsubmit="return confirm('Are you sure?');">
							<table class="widefat" style="margin-top: .5em">
								...
								<tr class='<?php echo $class; ?>'>
									...
									<td>                  
                    <center><?php echo $ll->id;?></center>                    
                  </td>
									<td>
                    <strong>
                      <a class="row-title" href="<?php echo get_option('siteurl').'/wp-admin/options-general.php?page=global-content-blocks&view=update&edid='.$ll->id;?>" title="Edit"><?php echo stripslashes($ll->name);?></a>
                    </strong>
									...
									<td>
                  [contentblock id=<?php echo $ll->id; ?>]
                  <?php if(strlen($ll->custom_id)):?>
                   <br />
                  [contentblock id=<?php echo $ll->custom_id; ?>]
                  <?php endif;?>
                  </td>
								</tr>
								<?php endforeach; ?>
